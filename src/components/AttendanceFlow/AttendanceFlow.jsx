...
const AttendanceFlow = ({ onBack: parentOnBack }) => {
    const navigate = useNavigate();
    const [step, setStep] = useState('classes'); // classes -> students -> modules -> lessons -> attendance
    ...
    const renderClassList = () => (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredClasses.length === 0 ? (
                <div className="col-span-full text-center text-gray-500">Bạn không có quyền điểm danh lớp nào.</div>
